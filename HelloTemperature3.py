...
mc.postToChat("Ready to read from Temperature 3!")
...
def TemperatureChart3(startx, starty, startz, maxchartwidth, maxchartheight, blocktype,id):
	global lastVal
	# Make a stage
...
while True:
	...
	TemperatureChart3(394, 68, -310, 2, 40, 35, 3)
